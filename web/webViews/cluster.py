...
class configView(normalView):
    ...
    def get(self):
        ...
        return self.render("config.html", allimages = allimages, allclusters = allclusters_info, external_fs_info=all_external_fs_info, mysession=dict(session), quota = quota, usage = usage, defaultsetting = defaultsetting, masterips = masterips)
